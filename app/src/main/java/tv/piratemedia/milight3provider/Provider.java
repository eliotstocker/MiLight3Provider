...
public class Provider extends ControlProviderReciever {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(DiscoveredIP == null) {
            prefs.getString("pref_light_controller_ip", null);
        }
        if(DiscoveredMac == null) {
            prefs.getString("pref_light_controller_mac", null);
        }
                ...
                public void handleMessage(Message msg) {
                    ...
                    switch(msg.what) {
                        case UDPConnection.DISCOVERED_DEVICE:
                            ...
                            Log.d("Retrieved Device Info", "IP: "+DiscoveredIP+", MAC: "+DiscoveredMac);
